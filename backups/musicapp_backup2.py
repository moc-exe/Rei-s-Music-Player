...
def main():
    ...
    layout = [
        ...
        sg.Button("Stop"), 
        sg.Button("Exit"), 
        sg.In(size=(25,1), enable_events=True ,key='-BROWSE-', visible=False), sg.FolderBrowse("Choose Folder"),
        sg.In(size=(25,1), enable_events=True, key = '-ADD_TRACK-', visible=False), sg.FileBrowse("Add Track File"),
        sg.Push()],
